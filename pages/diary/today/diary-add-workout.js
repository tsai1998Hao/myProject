...
export default function DiaryWorkoutForm({
  action,
  diary,
  handleSubmit,
  handleFieldChange,
        ...
        <div className="">
          <div className="card-body">
            <div className="col ">
              ...
              <div className="row flex-nowrap p-2 d-flex justify-content-center">
                <h6 className={styles.input}>活動種類</h6>
                <select
                  ...
                  required
                >
                  <option value="0">活動種類</option>
                  <option value="散步">散步</option>
                  <option value="坐下起立運動">坐下起立運動</option>
                  <option value="水療">水療</option>
                  <option value="重心移轉運動">重心移轉運動</option>
                </select>
              </div>
              <div className="row flex-nowrap p-2 d-flex justify-content-center">
